  ...
  if (!isValid) {
    return (
      <div className="p-4 flex flex-col items-center justify-center h-60">
        ...
        <p className="text-muted-foreground mb-4">ไม่พบข้อมูลโปรไฟล์ที่คุณต้องการ หรือ URL ไม่ถูกต้อง</p>
        <Button onClick={() => router.push("/ranking")} className="ai-gradient-bg">
          กลับไปหน้าจัดอันดับ
        </Button>
      </div>
    );
