        ...
        <div className="flex">
          {notification.avatar ? (
            <Avatar className="h-9 w-9 mr-3">
              ...
              <AvatarFallback>{notification.avatar.substring(0, 2)}</AvatarFallback>
            </Avatar>
          ) : (
            <div className={cn("h-9 w-9 rounded-full flex items-center justify-center mr-3", getNotificationBgColor(notification.type))}>
          ...
          <div className="flex-1">
            <div className="flex items-start justify-between">
              <div className="font-medium flex items-center">
                {notification.title}
                <Badge className={cn("ml-2 text-xs", getBadgeColor(notification.type))}>
                  {notification.type}
                </Badge>
              </div>
    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black/70">
      <div className="text-center bg-card p-8 rounded-xl shadow-lg border border-primary/20 max-w-md">
        ...
        <div className="space-y-2 mb-6">
          <Badge className="bg-amber-500/20 text-amber-400">Achievement Unlocked</Badge>
...
export const NotificationDemo: React.FC = () => {
  const { addNotification, notifications, markAsRead, removeNotification, markAllAsRead } = useNotification();
  ...
  const addDemoNotification = (type: NotificationType) => {
    ...
    switch (type) {
      ...
      case "achievement":
        ...
        notificationData.message = "Sales Champion: Complete 10 high-value sales deals";
        break;
      case "quest":
        notificationData.title = "Quest Completed";
        notificationData.message = "You've successfully completed 'Master Negotiator' quest";
        break;
      case "reward":
        notificationData.title = "Reward Available";
        notificationData.message = "You've earned 250 points! Check the reward shop for new items.";
        break;
      case "social":
        notificationData.title = "New Comment";
        notificationData.message = "Sarah Kim commented on your recent achievement";
        notificationData.avatar = "https://api.dicebear.com/7.x/adventurer/svg?seed=Sarah";
        break;
      case "message":
        notificationData.title = "New Message";
        notificationData.message = "Juan Rodriguez: Hey, can you help me with the quarterly report?";
        notificationData.avatar = "https://api.dicebear.com/7.x/adventurer/svg?seed=Juan";
        break;
    }
