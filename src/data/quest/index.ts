...
export const mockQuests = [
  ...
  },
  {
    ...
    description:
      'Conduct your weekly meeting with assigned clients and provide updates on products and services.',
    type: 'weekly',
    rewards: {
      xp: 85,
      stats: {
...
export const mockCompletedQuests = [
  ...
  },
  {
    ...
    description:
      'Provided a comprehensive update on project status to the team.',
    type: 'daily',
