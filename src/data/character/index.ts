...
export const mockJobClasses: JobClass[] = [
  {
    ...
    name: 'นักการตลาด',
    description:
      'ผู้เชี่ยวชาญด้านการวางแผนและดำเนินกลยุทธ์การตลาด มีความสามารถในการวิเคราะห์ตลาดและพฤติกรรมผู้บริโภค',
    levels: [
      {
        level: 1,
  ...
  },
  {
    ...
    name: 'นักขาย',
    description:
      'ผู้เชี่ยวชาญด้านการขายและเจรจาต่อรอง มีความสามารถในการสร้างความสัมพันธ์กับลูกค้าและปิดการขาย',
    levels: [
      {
        level: 1,
        requiredCharacterLevel: 1,
  ...
  },
  {
    ...
    name: 'นักบัญชี',
    description:
      'ผู้เชี่ยวชาญด้านการจัดการบัญชีและการเงิน มีความแม่นยำและละเอียดรอบคอบในการจัดการข้อมูลทางการเงิน',
    levels: [
      {
        level: 1,
        requiredCharacterLevel: 1,
...
const getNextLevelXP = (currentLevel: number): number => {
  ...
  const currentTotalXP =
    xpTable.find((x) => x.level === currentLevel)?.requiredXP || 0
  const nextTotalXP =
    xpTable.find((x) => x.level === currentLevel + 1)?.requiredXP || 0
...
const { jobLevel, jobLevelIndex } = getJobLevelForCharacter(
  selectedJobClass,
  characterLevel
)
...
export const characterPortrait =
  mockCharacter.portrait ||
  'https://same-assets.com/avatars/marketing-specialist-1.png'
