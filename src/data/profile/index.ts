...
export const mockUsers = {
  'user-1': {
    ...
    about: "Passionate sales professional with 10+ years of experience. Consistently exceeds targets and mentors junior team members.",
    achievements: [
      {
        id: "achievement-1",
        name: "Top Performer",
    ...
    badges: [
      { id: 'badge-1', name: 'Persuasive Negotiator', icon: '🤝', description: 'Exceptional negotiation skills' },
      { id: 'badge-2', name: 'Client Whisperer', icon: '👂', description: 'Deeply understands client needs' },
      { id: 'badge-3', name: 'Closing Expert', icon: '✍️', description: 'High deal conversion rate' }
    ]
  },
  'user-2': {
    id: 'user-2',
    ...
    about: "Detail-oriented accountant specializing in financial analysis and tax optimization strategies.",
    achievements: [
      {
        id: "achievement-1",
    ...
    badges: [
      { id: 'badge-1', name: 'Number Wizard', icon: '🧙‍♂️', description: 'Exceptional numerical analysis' },
      { id: 'badge-2', name: 'Audit Ace', icon: '🔍', description: 'Thorough and meticulous audit skills' },
      { id: 'badge-3', name: 'Financial Forecaster', icon: '📊', description: 'Accurate financial predictions' }
    ]
  },
  'user-3': {
    id: 'user-3',
    ...
    about: "Creative marketing professional with a data-driven approach to campaign optimization and brand development.",
    achievements: [
      {
        id: "achievement-1",
    ...
    badges: [
      { id: 'badge-1', name: 'Trend Spotter', icon: '📈', description: 'Identifies emerging market trends' },
      { id: 'badge-2', name: 'Brand Architect', icon: '🏛️', description: 'Expert at brand development' },
      { id: 'badge-3', name: 'Analytics Ace', icon: '📊', description: 'Data-driven marketing approach' }
    ]
  },
  'current-user': {
    id: 'current-user',
    ...
    about: "Marketing specialist with a passion for creative content and digital strategy. Just starting my journey!",
    achievements: [
      {
        id: "achievement-1",
        name: "First Blood",
    ...
    badges: [
      { id: 'badge-1', name: 'Fast Learner', icon: '🧠', description: 'Quickly adapts to new challenges' },
      { id: 'badge-2', name: 'Creative Spark', icon: '💡', description: 'Brings fresh ideas to the table' }
    ]
  }
};
