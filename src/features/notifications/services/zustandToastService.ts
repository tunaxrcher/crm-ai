...
export class ZustandNotificationToastService {
  ...
  public static getInstance(): ZustandNotificationToastService {
    if (!ZustandNotificationToastService.instance) {
      ZustandNotificationToastService.instance =
        new ZustandNotificationToastService()
    }
  ...
  public checkForNewNotifications(
    ...
    console.log(
      '🍞 Toast Service (Zustand) - Checking for new notifications:',
      {
        newUnreadCount,
    ...
    console.log(
      '🍞 Toast Service (Zustand) - Found new notifications:',
    ...
    if (newNotifications.length > 0) {
      newNotifications.forEach((notification, index) => {
        setTimeout(() => {
          console.log(
            '🍞 Toast Service (Zustand) - Showing toast for:',
            notification
          )
      ...
      console.log(
        '🍞 Toast Service (Zustand) - No new notifications to show:',
        {
  ...
  private showToastForNotification(
    ...
    console.log(
      '🍞 Toast Service (Zustand) - Showing toast for notification:',
      notification
    )
    ...
    console.log('✅ Toast Service (Zustand) - Toast added successfully!', {
      toastId,
    })
  }
...
export const zustandNotificationToastService =
  ZustandNotificationToastService.getInstance()
