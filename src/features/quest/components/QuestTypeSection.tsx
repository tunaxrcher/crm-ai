...
export default function QuestTypeSection({
  ...
  const getDifficultyBadge = (difficulty: QuestDifficulty) => {
    switch (difficulty) {
      case "easy":
        return <Badge className="bg-green-500/20 text-green-400 hover:bg-green-500/30">ง่าย</Badge>;
      case "medium":
        return <Badge className="bg-yellow-500/20 text-yellow-400 hover:bg-yellow-500/30">ปานกลาง</Badge>;
      case "hard":
        return <Badge className="bg-red-500/20 text-red-400 hover:bg-red-500/30">ยาก</Badge>;
      default:
            ...
            >
              <div className="flex-1">
                <div className="flex items-center">
                  ...
                  <h3 className={`text-base font-medium ${quest.completed ? 'text-muted-foreground' : ''}`}>
                    {quest.title}
                  </h3>
                </div>
                ...
                <div className="flex items-center mt-1 ml-4">
                  ...
                  <span className="text-xs text-yellow-400">{quest.rewards.xp} XP</span>
